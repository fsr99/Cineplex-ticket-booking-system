...
public class movies extends JFrame implements ActionListener {
    ...
    public movies() {
        ...
        b6.setBackground(new Color(0, 192, 0));
        ...
        l3 = new JLabel(new ImageIcon(getClass().getResource("/image/northman.jpg")));
        l3.setBounds(20, 150, 155, 210);
        P3.add(l3);

        l4 = new JLabel(new ImageIcon(getClass().getResource("/image/Hawa.jpg")));
        l4.setBounds(200, 150, 155, 210);
        P3.add(l4);

        l5 = new JLabel(new ImageIcon(getClass().getResource("/image/blackPanther.jpg")));
        l5.setBounds(380, 150, 155, 210);
        P3.add(l5);

        l6 = new JLabel(new ImageIcon(getClass().getResource("/image/blackAdam.jpg")));
        l6.setBounds(560, 150, 155, 210);
        P3.add(l6);

        
        l7 = new JLabel("The Northman");
