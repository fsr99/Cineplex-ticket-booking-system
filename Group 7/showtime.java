...
public class showtime extends JFrame implements ActionListener {
    ...
    public showtime() {
        ...
        l2 = new JLabel(new ImageIcon(getClass().getResource("/image/northman.jpg")));
        l2.setBounds(20, 100, 130, 170);
        P3.add(l2);

        l3 = new JLabel(new ImageIcon(getClass().getResource("/image/Hawa.jpg")));
        l3.setBounds(20, 295, 130, 170);
        P3.add(l3);

        l4 = new JLabel(new ImageIcon(getClass().getResource("/image/blackPanther.jpg")));
        l4.setBounds(385, 100, 130, 170);
        P3.add(l4);

        l5 = new JLabel(new ImageIcon(getClass().getResource("/image/blackAdam.jpg")));
        l5.setBounds(385, 295, 130, 170);
        P3.add(l5);

        // panel 3 component movie name

        l6 = new JLabel("The Northman");
